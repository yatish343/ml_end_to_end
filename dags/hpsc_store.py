...
TRANSFORMED_FEATURES_PATH = 'dags/features.csv'
...
def transform_data(**kwargs):
    ...
    # Save transformed features and target to CSV
    X_tfidf_df = pd.DataFrame.sparse.from_spmatrix(X_tfidf)
    X_tfidf_df.to_csv(TRANSFORMED_FEATURES_PATH, index=False)
...
with DAG(dag_id='code_classification',
